...
@section('content')
    ...
    <h1 class="font-display text-2xl md:text-3xl tracking-[0.2em] uppercase text-slate-100">Create admin</h1>
    <p class="text-sm text-slate-400 mt-1 mb-6">Grants full admin-console access. Use a strong, unique password.</p>

    <form method="POST" action="{{ route('admin.administrators.store') }}" class="space-y-4 max-w-lg">
        @csrf
        ...
        <div>
            <label class="block text-xs uppercase tracking-[0.2em] text-slate-400 mb-1.5" for="password_confirmation">Confirm password</label>
